...
const { addition , division , multiplication , subtraction , fullName} = require("./math")

fullName("Bhupendra .K. patil");
addition(88,99)
multiplication(89 , 9)
division(10,20)
subtraction(88 , 76)
...
// import { sumOfTwoNumbers } from "./math2";

// sumOfTwoNumbers(88 ,99)